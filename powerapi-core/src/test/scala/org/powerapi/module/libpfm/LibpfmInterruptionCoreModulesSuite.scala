...
class LibpfmInterruptionCoreModulesSuite extends UnitTest {
  ...
  "The LibpfmInterruptionCoreModule class" should "create the underlying classes (sensor/formula)" in {
    val module = new LibpfmInterruptionCoreModule(Map(10 -> Set(10)), Set("e1"), "Threads", "Refs", Map(1d -> List(1d, 2d)), 10.milliseconds)

    module.sensor.get._1 should equal(classOf[LibpfmInterruptionCoreSensor])
    module.sensor.get._2.size should equal(2)
    module.sensor.get._2(0) should equal(Map(10 -> Set(10)))
    module.sensor.get._2(1) should equal(Set("e1"))

    module.formula.get._1 should equal(classOf[LibpfmInterruptionCoreCyclesFormula])
  ...
  "The LibpfmInterruptionCoreModule object" should "build correctly the companion class" in {
    val module1 = LibpfmInterruptionCoreModule()
    val module2 = LibpfmInterruptionCoreModule(Some("libpfm"))
    ...
    module1.sensor.get._1 should equal(classOf[LibpfmInterruptionCoreSensor])
    module1.sensor.get._2.size should equal(2)
    module1.sensor.get._2(0) should equal(Map(0 -> Set(0, 4), 1 -> Set(1, 5), 2 -> Set(2, 6), 3 -> Set(3, 7)))
    module1.sensor.get._2(1) should equal(Set("CPU_CLK_UNHALTED:THREAD_P", "CPU_CLK_UNHALTED:REF_P"))

    module1.formula.get._1 should equal(classOf[LibpfmInterruptionCoreCyclesFormula])
    ...
    module2.sensor.get._1 should equal(classOf[LibpfmInterruptionCoreSensor])
    module2.sensor.get._2.size should equal(2)
    module2.sensor.get._2(0) should equal(Map(0 -> Set(0, 4), 1 -> Set(1, 5), 2 -> Set(2, 6), 3 -> Set(3, 7)))
    module2.sensor.get._2(1) should equal(Set("event"))

    module2.formula.get._1 should equal(classOf[LibpfmInterruptionCoreCyclesFormula])
