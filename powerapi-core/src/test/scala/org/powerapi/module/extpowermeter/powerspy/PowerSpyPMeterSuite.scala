...
class PowerSpyPMeterSuite extends UnitTest {
  ...
  "A PowerSpyPMeter" should "open the connection with the PowerSpy and publish raw power reports" ignore new Bus {
    val pMeter = new PowerSpyPMeter("00:06:66:4D:F4:BB", 1.seconds)
