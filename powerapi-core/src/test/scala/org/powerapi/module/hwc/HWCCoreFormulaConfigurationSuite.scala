...
class HWCCoreFormulaConfigurationSuite extends UnitTest {
  ...
  "The HWCCoreFormulaConfiguration" should "read correctly the values from a resource file" in new Formulae {
    val configuration1 = new HWCCoreFormulaConfiguration(None)
    val configuration2 = new HWCCoreFormulaConfiguration(Some("hwc"))
