...
object ProjectBuild extends Build {
  ...
  lazy val jss18 = Project(id = "powerapi-jss-18", base = file(".")).settings(rootSettings: _*).aggregate(expProcessLevelXeon, expDomainPowerModelTegra4C, expDomainPowerModelTegra1C, expSystemImpactXeon, hpcAnalysisDefault)
