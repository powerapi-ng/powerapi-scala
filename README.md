...
* [BridJ](https://code.google.com/p/bridj/) (version 0.6.2 under [BSD-3-Clause licence](https://github.com/ochafik/nativelibs4java/blob/master/libraries/BridJ/LICENSE)), for system or C calls.
